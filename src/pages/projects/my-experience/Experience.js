    ...
    <Fragment>
      <ProjectContainer className="spr">
        ...
        <ProjectHeader
          ...
          url="https://bit.ly/joaoemersonengineer"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>The things change</ProjectSectionHeading>
            <ProjectSectionText>
            We all need to imagine how we can change, improve and evolve.
            I did the same by transforming my old portfolio into pure HTML in this one with the most current technologies on the market
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                ...
                <Button
                  ...
                  icon="chevronRight"
                  href={'https://www.linkedin.com/in/joaoemerson-profissional/'}
                >
              ...
              <Image
                ...
                alt="A small demonstration of my Linkedin Profile"
        ...
        <ProjectSection>
          <ProjectSectionColumns>
            <ProjectSectionContent>
              <ProjectTextRow>
                <ProjectSectionHeading>
                  Its just a beautiful explanation of how javascript is powerful. See below.
                </ProjectSectionHeading>
              </ProjectTextRow>
            </ProjectSectionContent>
          </ProjectSectionColumns>
